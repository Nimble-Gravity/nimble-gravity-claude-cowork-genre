...
> Demo profile for the Gen Re Cowork Workshop 1 "before / after." Fictional persona — Maya Chen.
> Drop `claude.md` and the `about-me/` folder into a Cowork workspace to load the "after" profile.
...
- Keep `about-me/memory.md` current: when you learn a durable fact about me, my projects, or my
  team during a session, add or update it there — and review `memory.md` at the end of each
  session. Keep `about-me/team.md` current the same way.
- When you're unsure about my context, read `about-me/` before guessing — don't invent details about my work.
